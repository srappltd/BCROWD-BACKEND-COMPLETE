...
exports.LevelIncomeDistribute = async ({ userId, amount,teamIncomeId }) => {
    try {
        ...
        const distributeArray = [
            { commition: amount * 0.10,percentage:0.10, level: "Level 01" },
            { commition: amount * 0.10,percentage:0.10, level: "Level 02" },
            { commition: amount * 0.10,percentage:0.10, level: "Level 03" },
            { commition: amount * 0.10,percentage:0.10, level: "Level 04" },
            { commition: amount * 0.10,percentage:0.10, level: "Level 05" },
